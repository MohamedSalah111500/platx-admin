...
import { CandidateList, JobApplydata, JobGriddata, JobListdata, chatData, chatMessagesData, customersData, listData, orders, ordersData, projectData, recentFiles, tasks, userGridData, userList } from '../data';
